...
- **Coverage Goal:** A strict **100% line coverage** is mandated and enforced via `pytest-cov`. Any commit dropping coverage below this threshold or failing to include complete real-world scenario tests will fail the CI pipeline.
